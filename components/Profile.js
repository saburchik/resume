            ...
            <div className="profile__inner">
                <section className="profile__header">
                    ...
                    <div className="profile__lang">
                        ...
                        <select className="profile__select" value={context.locale} onChange={context.setLang}>
                ...
                <div className="profile__img">
                    <Image className={s.myphoto} src="/img/me.jpg" width={208} height={272} alt="myphoto" />
                </div>
