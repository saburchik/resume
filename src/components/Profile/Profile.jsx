            ...
            <div className="profile__inner">
                <div className="profile__header">
                    <div style={{ marginBottom: '1rem' }}  >
                        <h1 className="profile__name lng-myname">
                    ...
                    <div className="profile__lang">
                        <svg style={{ fill: '#8c8c8c', width: '25px', height: '25px' }} viewBox="0 0 496 512">
                            <path
                        ...
                        <select value={context.locale} onChange={context.setLang} className="profile__select">
                ...
                <ul className="profile__info">
                    ...
                    <li>
                        <h2 className="profile__item">— E-mail: <span style={{ color: '#393939' }}>the.saburchik@gmail.com</span>
