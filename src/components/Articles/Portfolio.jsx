            ...
            <div className="portfolio">
                <div className="portfolio__inner">
                    <a className="portfolio__item" href="https://saburchik.github.io/Chelsea-release/" rel="noreferrer"
                        target="_blank">
                        <picture>
                            <source srcSet={chelseaImgWEBp} type="image/webp" /><img
                                className="portfolio__img" src={chelseaImgJPG} alt="Изоб-ние проекта" />
                        </picture>
                    ...
                    <a className="portfolio__item" href="/" rel="noreferrer" target="_blank">
                        <picture>
                            <source srcSet={republicImgWEBp} type="image/webp" /><img
                                className="portfolio__img" src={republicImgJPG} alt="Изоб-ние проекта" />
                        </picture>
