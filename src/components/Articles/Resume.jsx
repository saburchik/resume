    ...
    return (
        <article className="tabs__content">
            ...
            <article style={{ marginBottom: '2rem' }}>
                <h3 className="title__resume">Опыт & навыки:</h3>
                <ul className="list__resume">
                    <li>Кроссбраузерная верстка, с использованием методологии <strong>БЭМ</strong>(либо модульный CSS);</li>
                    <li>Использование чистого <strong>CSS</strong>, либо препроцессора
                        <strong> SASS</strong>;</li>
                    ...
                    <li>Опыт использование <strong>Gulp</strong> и
                        <strong> Webpack</strong>, для автоматизации некоторых процессов;</li>
                    <li>Рабочие инструменты: <strong>VS Code</strong>, <strong>Figma</strong>.</li>
                </ul>
            </article>

            <article>
                <h3 className="title__resume">Прочие интересы:</h3>
                <ul className="list__other">
                    <li>
                        <svg class="svg-inline--fa fa-book-medical fa-w-14" viewBox="0 0 448 512">
                        ...
                        <p>Физическое и ментальное здоровье</p>
                    </li>
                    <li>
                        <svg class="svg-inline--fa fa-hand-holding-usd fa-w-18" viewBox="0 0 576 512">
                        ...
                        <p>Инвестирование, криптовалюта</p>
                    </li>
                    <li>
                        <svg class="svg-inline--fa fa-square-root-alt fa-w-18" viewBox="0 0 576 512">
                        ...
                        <p>Математика и фундаментальные знания</p>
                    </li>
                </ul>
            </article>
        </article>
